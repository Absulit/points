    ...
    update({usin, ucos, side, utime, nusin, sliders}) {
        ...
        for (const particle of this._particles) {
            ...
            if (point) {
                ...
                pointAbove.modifyColor(color => {
                    //color.add(new RGBAColor(1 - x, 1 - y, x * nusin));
                    //color.set(1 - x, 1 - y, x * nusin);
                    color.add(RGBAColor.average([new RGBAColor(1 - x, 1 - y, x * nusin), this._clearMixColor]));
                });
        ...
        this._screen.clearAlpha(1.0001);
