...
export default class EffectsTester {
    ...
    async update({ usin, ucos, side, utime, nusin, fnusin }) {
        ...
        //screen._colors = this._empt.slice();
        screen.clear(this._clearMixColor);
        //screen._colors = new Float32Array(screen.numColumns *screen.numRows * 4);
        ...
        let p = screen.getPointAt(0,0);
        p.modifyColor(color => color.set(1,0,0));
