...
export default class Noise2_3 {
    ...
    update({ fnucos, fnusin, fusin, side, fnsin, sliders }) {
        ...
        screen.points.forEach(point => {
            ...
            const d = Math.sin(MathUtil.angle(point.coordinates, screen.center) * Math.PI * 2 * sliders.a /** 50 + 10 * fnusin(.57)*/);
            ...
            if (p) {
                ...
                if (newPoint) {
                    ...
                    screen.drawLineWithPoints(p, newPoint, color => {
                        ...
                        color.add(p.color);
                        //color.add(RGBAColor.average([color, p.color]));
                        //color.add(newPoint.color);
                        //color.blend(p.color);
                    ...
                    //     return item !== c
                    // })
                    // this._coordinates.push(screen.getRandomPoint().coordinates);
        ...
        this._screen.clearMix(this._clearMixColor, 10);
