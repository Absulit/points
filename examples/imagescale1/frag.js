...
fn main(
    ...
    let rgbaImage1 = texturePosition2(image1, feedbackSampler, startPosition, uvr, false);
    let rgbaImage2 = texturePosition2(image2, feedbackSampler, startPosition, uvr, true);
    let rgbaImage3 = texturePosition2(image3, feedbackSampler, startPosition, uvr, true);
