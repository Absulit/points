...
fn customVertexBody(position:vec4f, color:vec4f, depth:vec4f, noise:f32, uv:vec2f, normal: vec3f) -> CustomFragment {
...
fn main(
    ...
    return customVertexBody(clip, particle.color, depth, particle.noise, uv, newNormal);
