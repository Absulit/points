...
fn main(
    ...
    for(var i:u32; i<10;i++){
        ...
        finalColor += sdfSquare(p, params.sliderA, params.sliderB, radians(360) * fnusin(2),uvr) * vec4(uvr.x,1-uvr.y,0,  fi/10);
    }
    ...
    for(var k:u32; k < numPoints; k++){
        ...
        finalColor += sdfLine2( pointPosition, pointPosition2, .001 + .1 * params.sliderC, uvr / ratio );
        //finalColor += sdfLine(pointPosition, pointPosition2, .001 + 10 * params.sliderC, uvr  );
    }
