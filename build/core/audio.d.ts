 ...
 */
declare const audioAverage = "fn audioAverage(sound:Sound)->f32{var audioAverage=0.;for(var index=0;index < i32(params.audioLength);index++){let audioValue=sound.data[index] / 256;audioAverage+=audioValue;}return audioAverage / params.audioLength;}";
/**
 * WIP
 * @param {i32} segmentNum
 * @returns {f32}
 */
declare const audioAverageSegments = "fn audioAverageSegments(segmentNum:i32)->f32{return .0;}";
