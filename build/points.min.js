...
`;bindingIndex+=1}}this.#samplers.forEach(sampler=>{const isInternal=internal===sampler.internal;if(isInternal&&(!sampler.shaderType||sampler.shaderType&shaderType)){dynamicGroupBindings+=`@group(${groupId}) @binding(${bindingIndex}) var ${sampler.name}: sampler;
